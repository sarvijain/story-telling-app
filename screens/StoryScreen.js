...
export default class StoryScreen extends Component {
  ...
  render() {
    if (!this.props.route.params) {
      ...
      return (
        <View style={this.state.light_theme?styles.containerWhite:styles.container}>
          ...
          <View style={styles.appTitle}>
            ...
            <View style={styles.appTitleTextContainer}>
              <Text style={this.state.light_theme?styles.appTitleTextWhite:styles.appTitleText}>Storytelling App</Text>
            </View>
          </View>
          <View style={styles.storyContainer}>
            <ScrollView style={this.state.light_theme?styles.storyCardWhite:styles.storyCard}>
              <Image
              ...
              <View style={styles.storyTextContainer}>
                <Text style={this.state.light_theme?styles.storyTextWhite:styles.storyText}>
                  {this.props.route.params.story.story}
                </Text>
                <Text style={this.state.light_theme?styles.moralTextWhite:styles.moralText}>
              ...
              <View style={styles.actionContainer}>
                <View style={styles.likeButton}>
                  ...
                  <Text style={this.state.light_theme?styles.likeTextWhite:styles.likeText}>12k</Text>
                </View>
              </View>
            </ScrollView>
          </View>
